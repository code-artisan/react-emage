...
export class ImageUriCache {
  ...
  static _cleanUpIfNeeded() {
    ...
    if (imageUris.length + 1 > ImageUriCache._maximumEntries) {
      ...
      let leastRecentlyUsedEntry: any;
...
let id = 0;
const requests: {[key: string]: HTMLImageElement | null} = {};
...
const ImageLoader = {
  ...
  load(uri: string, onLoad: (e: any) => void, onError: (e: any) => void): number {
    id += 1;
